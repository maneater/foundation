									...
									<div id="detailItem1" class="detailItemDiv item">
										...
										<div class="contentRight fl">
											...
											<div class="detailController">
												<input style="margin-bottom: 10px;" type="button" value="Back" onclick="formBack()" />
												<input style="margin-bottom: 10px;" class="ml10" type="button" value="Next" onclick="formNext()" />
